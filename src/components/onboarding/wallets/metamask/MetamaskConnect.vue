...
<template>
  <Card class="w-[350px]">
    ...
    <CardContent class="text-sm">
      ...
      <div
        v-if="!isMetamaskSnapInstalled && !isLoading"
        class="space-y-4"
      >
      ...
      <div v-if="isMetamaskSnapInstalled">
        <div v-if="accountsMatchingKeys">
          <div v-if="showUpdateAccountModal">
            <p class="mb-4">
              Step 6: Fill in this form in order to create account update operation, replacing memo public key and adding posting, active and owner keys to your account:
            </p>
            <AccountNameInput
          ...
          <div v-else-if="showCreateAccountModal">
            <p class="mb-4">
              Step 6: Fill in this form in order to prepare the operation to request account creation
            </p>
            <AccountNameInput
              id="wallet_account_name"
              v-model="createAccountNameOperation!"
